...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-end mb-4">
        <a href="/admin/payroll_create.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300">Create Payroll</a>
    </div>
